...
class Entity {
  constructor() {
    this.playerCharacter = 'images/';
    this.x = 2;
    this.y = 5;
  }

  render() {
    ctx.drawImage(Resources.get(this.playerCharacter), this.x * 101, this.y * 83);
  }
...
class Player extends Entity {
  constructor() {
    super();
    this.playerCharacter += 'char-boy.png';
    this.win = false;
  }
...
class Enemy extends Entity {
  constructor(x, y, speed) {
    super();
    this.playerCharacter += 'enemy-bug.png';
    this.x = x;
    this.y = y;
    this.speed = getSpeed();
  }
